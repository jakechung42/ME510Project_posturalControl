...
A = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\NNinput_ABCL_9(4).dat');   % Desired input to NN
...
B = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\ErrorN3_ABCL_9(4).dat');   % Error N3 outputs
...
C = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\Kp_ABCL_9(4).dat');   % Kp*Error circuit outputs
...
D = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\Kd_ABCL_9(4).dat');   % Kd*de/dt circuit outputs
...
E = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\NNOutput_ABCL_9(4).dat');   % NN circuit outputs
...
F = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\NNangleOut_ABCL_9(4).dat');   % Actual output (input to NN)
...
G = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\Kpscaler_ABCL_9(4).dat');   % Kp scaler
...
H = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\Kdscaler_ABCL_9(4).dat');   % Kd scaler
...
J = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\Kpsyngain_ABCL_9(4).dat');   % Kp syn gain only
...
K = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\Kdsyngain_ABCL_9(4).dat');   % Kd syn gain only
...
L = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\kdpregain_ABCL_9(4).dat');   % Kd syn gain only
...
M = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABCL_NNOutputs\ErrorScope_ABCL_9(4).dat');   % Kd syn gain only
% L = importdata('C:\Users\Tiffany\Desktop\B_NN_Outputs\KdsyngainABCLTest1(0.4).dat');   % Kd syn gain only
Mf1 = M(:,2);  
Mf2 = M(:,3);
Mf3 = M(:,4);  
...
ylabel('Amplitude (nA)')
title('Frequency 1')
legend('Error','NNoutput','System Output','Location','northeast')
xlim([0 70])
ylim([-5 5])
...
ylabel('Amplitude (nA)')
title('Frequency 1')
legend('Desired Angle','Error','Actual Angle','Location','northeast')
xlim([0 60])
ylim([-10 10])
set(gcf, 'Color', 'w');
