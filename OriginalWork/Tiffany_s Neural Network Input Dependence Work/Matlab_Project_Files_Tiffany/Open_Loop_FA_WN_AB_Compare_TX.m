...
A = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\PD_ABOL_10(0.1).dat');   % sys circuit outputs
freq = A(:,1);      % rad/s
magRatioOL_a = A(:,2);  
phaseOL_a = A(:,3);
OLstd_a = A(:,4);

B = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kp_ABOL_10(0.1).dat');   % Kp circuit outputs
magRatioKp_a = B(:,2);  
phaseKp_a = B(:,3);
error_a = B(:,4);
Kpstd_a = B(:,8);

C = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kd_ABOL_10(0.1).dat');   % Kd circuit outputs
magRatioKd_a = C(:,2);
phaseKd_a = C(:,3);

F1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kdsyngain_ABOL_10(0.1).dat');   % Kd circuit outputs
Kdsyngain_a = F1(:,2);

B2 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\kdbase_ABOL_10(0.1).dat');   % Kd circuit outputs
kdbase_a = B2(:,2);

P1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kpsyngain_ABOL_10(0.1).dat');   % Kp syn gain
Kpsyngain_a = P1(:,2);
Kdsynstd_a = P1(:,4);

D = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\PD_ABOL_10(4).dat');   % sys circuit outputs
magRatioOL_b = D(:,2);  
phaseOL_b = D(:,3);
OLstd_b = D(:,4);

E = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kp_ABOL_10(4).dat');   % Kp circuit outputs
magRatioKp_b = E(:,2);  
phaseKp_b = E(:,3);
error_b = E(:,4);

F = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kd_ABOL_10(4).dat');   % Kd circuit outputs
magRatioKd_b = F(:,2);
phaseKd_b = F(:,3);
Kpstd_b = F(:,8);

G1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kdsyngain_ABOL_10(4).dat');   % Kd circuit outputs
Kdsyngain_b = G1(:,2);
Kdsynstd_b = G1(:,4);

C2 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\kdbase_ABOL_10(4).dat');   % Kd circuit outputs
kdbase_b = C2(:,2);

Q1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\ABOL_Outputs\Kpsyngain_ABOL_10(4).dat');   % Kp syn gain
Kpsyngain_b = Q1(:,2);
...
% PD files
% Run a
D1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\WNOL_NNOutputs\ErrorN3_WNOL_5(0.5).dat');   % Desired input to NN
timeWNOL_a = D1(:,1);      % s
Error_N3WNOL_a = D1(:,2);  

E1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\WNOL_NNOutputs\NNOutput_WNOL_5(0.5).dat');   % Actual output (input to NN)
NNOutputWNOL_a = E1(:,2);  

% Kp files
X1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\WNOL_NNOutputs\ErrorScope_WNOL_5(0.5).dat');   % Desired input to NN
ErrorScopeWNOL_a = X1(:,2);  

Y1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\WNOL_NNOutputs\KpCircuitScope_WNOL_5(0.5).dat');   % Actual output (input to NN)
KpCircuitScopeWNOL_a = Y1(:,2); 

% Kd files
Z1 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\WNOL_NNOutputs\kdbasegain_WNOL_5(0.5).dat');   % Desired input to NN
kdbasegainWNOL_a = Z1(:,2);  

A2 = importdata('C:\Users\Tiffany\Desktop\Sim_Outputs\WNOL_NNOutputs\KdCircuitScope_WNOL_5(0.5).dat');   % Actual output (input to NN)
...
Kdstart = 0.01; Kdend = 0.1; Kddivs = 60;
...
% Auto Bode & WN Compare Figs
figure
semilogx(f_fftWNOL_a,magSys_a,'o')
hold on
semilogx(f_fftWNOL_a,magWN_a,'Linewidth',1.4,'Color','b')
% semilogx(f_fftWNOL_a,magKpKdWN_a,'--','Linewidth',1.4)
% semilogx(f_fftWNOL_b,magWN_b,'Linewidth',1.4)
semilogx(f_fftWNOL_a,magWN_a+PDstdev_a,'-.','Color','b')
semilogx(f_fftWNOL_a,magWN_a-PDstdev_a,'-.','Color','b')
% semilogx(f_fftWNOL_b,magKpKdWN_b,'--','Linewidth',1.4)
semilogx(freq_Hz,magRatioOL_a,'-s','Linewidth',1.4,'Color','k')
semilogx(freq_Hz,magRatioOL_a+3*OLstd_a,'--','Linewidth',1.4,'Color','k')
semilogx(freq_Hz,magRatioOL_a-3*OLstd_a,'--','Linewidth',1.4,'Color','k')
semilogx(freq_Hz,magRatioOL_b,'-d','Linewidth',1.4,'Color','m')
semilogx(freq_Hz,magRatioOL_b+3*OLstd_b,'--','Linewidth',1.4,'Color','m')
semilogx(freq_Hz,magRatioOL_b-3*OLstd_b,'--','Linewidth',1.4,'Color','m')
...
title('Open Loop System Baseline')
legend('White Noise Data',['White Noise Fit Kp = ' num2str(KpPDFitWN_a,2) ',  Kd = ' num2str(KdPDFitWN_a,2)],['WN Fit: +1std = ' num2str(PDstdev_a,2)],'WN Fit: -1std','Auto Bode Data 0.1nA Input','AB 0.1nA Input + 3std','AB 0.1nA Input - 3std','Auto Bode Data 4nA Input','AB 4nA Input + 3std','AB 4nA Input - 3std','Location','northwest')
